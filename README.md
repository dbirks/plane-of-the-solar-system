...
- The pull-out is **one continuous motion straight to the ball**: the reveal starts around 300 m up (your blue dot appears almost immediately), and Earth arrives **centered and visibly tilted against the flat plane, your dot on its front face, small axis stubs reading the tilt** — no atmosphere or low-orbit stops, no nadir detour; from there to 80 AU the journey only zooms
- **Pinch to travel**: two fingers zoom the journey itself, at every scale
