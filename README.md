...
- The pull-out looks down at **your own yellow dot** from the first kilometres up, then the camera **arcs around the planet** to an anti-sunward vantage: Earth stands alone with your dot on its side and the Sun, Mercury, and Venus in the background — day or night — while the gaze never leaves Earth, so the journey never spins
...
- 89 unit tests, 44 Playwright scenarios (desktop + mobile), and GitHub Pages deployment
